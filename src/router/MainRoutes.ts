const MainRoutes = {
    ...
    children: [
        ...
        }, */
        {
            name: 'Advertising',
            path: '/advertising',
            component: () => import('@/views/calculators/Advertising.vue')
        },
        {
            name: 'Calculator',
            path: '/calculator',
            component: () => import('@/views/calculators/Calculator.vue')
        },
        {
            name: 'Result',
            path: '/calculator/result',
            component: () => import('@/views/calculators/CalculatorResult.vue')
        },
        {
            name: 'UserProfile',
