...
<template>
    ...
    <!-- <v-menu open-on-hover :close-on-content-click="false" class="lp_wrapper position-relative">
        <template v-slot:activator="{ props }">
            <v-btn class="hidden-sm-and-down nav-links custom-hover-primary" rounded="sm" variant="text" color="primary"
                v-bind="props">Demos
...
<v-sheet max-width="100%" width="1150" height="100%" elevation="10" rounded="md" class="pa-8 mx-auto">
    ...
    <!-- <v-menu open-on-hover :close-on-content-click="false" class="lp_wrapper position-relative">
        <template v-slot:activator="{ props }">
            <v-btn class="hidden-sm-and-down custom-hover-primary nav-links" rounded="sm" variant="text" color="primary"
                v-bind="props">Pages
                <ChevronDownIcon size="18" class="mt-1 ml-1" />
            </v-btn>
        </template>
    ...
    <v-btn variant="text" color="text" class="custom-hover-primary nav-links" to="" target="_blank">{{ $t('Home')
        }}</v-btn>
    <v-btn variant="text" color="text" class="custom-hover-primary nav-links" to="" target="_blank">{{ $t('About Us')
        }}</v-btn>
    <v-btn variant="text" color="text" class="custom-hover-primary nav-links" to="/advertising">{{ $t('Calculators')
        }}</v-btn>
    <v-btn variant="text" color="text" class="custom-hover-primary nav-links" to="" target="_blank">{{ $t('Research')
        }}</v-btn>
    <v-btn variant="text" color="text" class="custom-hover-primary nav-links" to="" target="_blank">{{ $t('Services')
        }}</v-btn>
